...
public struct TokenCostDashboardAnalytics: Sendable {
    ...
    public init(payload: DashboardPayload) {
        ...
        self.providerCacheRows = providerAccumulators
            ...
            .sorted { lhs, rhs in
                ...
                return lhs.cacheReadTokens > rhs.cacheReadTokens
            }

        self.providerRankRows = Self.buildProviderRankRows(from: providerAccumulators, effectiveCosts: providerEffectiveCosts)
        self.modelComparisonRows = Self.buildModelComparisonRows(
            from: modelAccumulators,
            providerAccumulators: providerAccumulators,
            providerEffectiveCosts: providerEffectiveCosts
        )
        self.modelSlices = Self.buildDistributionSlices(
            valuesByKey: modelAccumulators.mapValues { $0.total },
            topLimit: 7,
            otherLabel: "其他",
            otherColorKey: "other-models"
        )
        self.providerSlices = Self.buildDistributionSlices(
            valuesByKey: providerAccumulators.mapValues { $0.total },
            topLimit: 7,
            otherLabel: "其他",
        ...
        self.stackedSeries = Self.buildStackedSeries(
            ...
            modelAccumulators: modelAccumulators
        )
    }
